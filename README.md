...
| Attach a label                     | `attach_ticket_label` (since 0.1.3)          |
| Detach a label                     | `detach_ticket_label` (since 0.1.3)          |
| Delete a ticket                    | `delete_ticket` (since 0.1.3)                |
| Mark as spam                       | `mark_ticket_as_spam`                        |
| Unmark as spam                     | `unmark_ticket_as_spam`                      |
| Set custom data                    | `set_custom_data` (since 0.1.3)              |
| Delete a message                   | `delete_message` (since 0.1.3)               |
| Send a ticket message              | `send_ticket_message` (since 0.1.3)          |
| Send a ticket media message        | `send_ticket_media_message` (since 0.1.3)    |
| List all messages                  | `get_messages` (since 0.1.3)                 |
| Mark a ticket as favorite          | `mark_ticket_as_favorite`                    |
| Unmark a ticket as favorite        | `unmark_ticket_as_favorite`                  |
| Fetch a message                    | `get_message` (since 0.1.3)                  |
