...
| Assign a ticket                    | `assign_ticket` (since 0.1.2) |
| Close a ticket                     | `close_ticket` (since 0.1.2)  |
| Reopen a ticket                    | `reopen_ticket` (since 0.1.2) |
| Merge a ticket                     | `merge_ticket` (since 0.1.2)  |
| Attach a label                     |                               |
| Detach a label                     |                               |
| Delete a ticket                    |                               |
